...
export default function Contact() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center px-4 lg:px-5 2xl:px-[30px]">
      ...
      />
      <div className="flex flex-col gap-[50px] w-full lg:px-[60px] 2xl:px-[142px] lg:gap-[80px] 2xl:gap-[100px] bg-absolute-white rounded-xl">
        <div className="flex flex-col">
          <form className="flex flex-col gap-5 p-[30px]">
            <TextInput label="First Name" labelClassName="mb-3" name="firstName" placeholder="Enter First Name" />
            <TextInput label="Last Name" labelClassName="mb-3" name="lastName" placeholder="Enter Last Name" />
            <TextInput label="Email" labelClassName="mb-3" name="email" placeholder="Enter your Email" type="email" />
            <TextInput label="Phone" labelClassName="mb-3" name="phone" placeholder="Enter Phone Number" type="tel" />
            <TextInput label="Subject" labelClassName="mb-3" name="subject" placeholder="Enter your Subject" />
            <TextInput label="Message" labelClassName="mb-3" name="message" placeholder="Enter your Message here..." rows={5} />
            <button className="text-absolute-white text-[14px] font-medium rounded-md bg-orange-50 hover:bg-orange-70 py-[14px] px-5 mt-[10px]" type="submit">
              Send Your Message
            </button>
          </form>
          <div className="flex flex-col gap-5 p-[30px] border-t border-white-97">
